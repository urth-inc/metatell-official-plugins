...
class ContainerEntryModule extends Module {
     ...
     */
    constructor(name, exposes, shareScope, injectRuntimeEntry, experiments) {
     ...
     */
    identifier() {
        return `container entry (${this._shareScope}) ${JSON.stringify(this._exposes)} ${this._injectRuntimeEntry} ${JSON.stringify(this._experiments)}`;
    }
    /**
